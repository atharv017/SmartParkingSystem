    ...
    return (
        <div className='container py-5'>
            <div className='card create-parking-card p-5'>
                ...
                <button type="submit" className="btn  mt-4 mb-4" onClick={handleUpdateUserPassword}>Update</button>
                ...
                <button type="submit" className="btn  mt-4" onClick={handleResetPassword}>Change Password</button>
            </div>
        </div>
    )
}
